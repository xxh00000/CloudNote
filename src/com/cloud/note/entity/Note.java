...
private String cn_note_status_id;//1表示正常，2表示被删除
private String cn_note_type_id;
private String cn_note_title;
private String cn_note_body;
private BigInteger cn_note_create_time;
private BigInteger cn_note_last_modify_time;

public BigInteger getCn_note_create_time() {
	return cn_note_create_time;
}
public void setCn_note_create_time(BigInteger cn_note_create_time) {
	this.cn_note_create_time = cn_note_create_time;
}
public BigInteger getCn_note_last_modify_time() {
	return cn_note_last_modify_time;
}
public void setCn_note_last_modify_time(BigInteger cn_note_last_modify_time) {
...
public String toString() {
	return "Note [cn_note_id=" + cn_note_id + ", cn_notebook_id=" + cn_notebook_id + ", cn_user_id=" + cn_user_id
			+ ", cn_note_status_id=" + cn_note_status_id + ", cn_note_type_id=" + cn_note_type_id + ", cn_note_title="
			+ cn_note_title + ", cn_note_body=" + cn_note_body + ", cn_note_create_time=" + cn_note_create_time
